...
local makeSkillUi = function()
	...
	--{ 작업 상태
		...
		self._workingNameTitle	:SetPosX( 20 )
		self._workingNameTitle	:SetPosY( 7 )
		self._workingNameValue	:SetPosX( 70 )
		self._workingNameValue	:SetPosY( 7 )
	--
	...
	for idx = 0, 6 do
		...
		self._skill[idx].name		:SetPosY( 2 )
...
function FGlobal_ShowWorkerTooltip( workerData, uiBase, isRight, isPlant )
	...
	if nil ~= defaultSkill then
		...
		controlWorkerTooltip._skilBox			:SetSpanSize( 0, 255 )
		...
		controlWorkerTooltip._workerBg			:SetSize( controlWorkerTooltip._workerBg:GetSizeX(), 530 )

		tempPenelSizeY = controlWorkerTooltip._panel_Size + 70
	else
		...
		controlWorkerTooltip._workerBg			:SetSize( controlWorkerTooltip._workerBg:GetSizeX(), 460 )

		tempPenelSizeY = controlWorkerTooltip._panel_Size
	end
	...
	if false == isWaitWorker(workerData) then
		...
		workName = workerWrapper:getWorkString()
