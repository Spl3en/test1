...
function DyeNew:Initialize()
	...
	-- { 기타 설정
		...
		self.btn_AwakenWeapon			:SetPosX( self.btn_HelmHide:GetPosX() + self.btn_HelmHide:GetSizeX() )
...
function HandleClicked_DyeNew_SetHideHelmet() 
	...
	ToClient_RequestHideBattleHelmet(DyeNew.isHideBattleHelmet)
end
