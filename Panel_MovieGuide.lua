...
elseif isGameTypeEnglish() then
	movieDesc = {
		...
		[13] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_10"), -- 채집과 가공 방법
		[14] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_11"), -- 공헌도 : 거점 연결 및 회수
		[15] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_12"), -- 공헌도 : 집 용도 변경 및 회수
		[16] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_13"), -- 공헌도 : 대여 아이템 활용
		[17] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_14"), -- 말 조련 및 마구간 등록
		[18] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_15"), -- 일꾼 고용 및 일 시키기
		[19] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_16"), -- 낚시하기
		[20] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_17"), -- NPC 지식 모으기
		[21] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_18"), -- NPC 발견 조건
		[22] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_19"), -- 이야기 교류 및 친밀도 상점
		[23] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_20"), -- 주거지 배치 및 이사 안내
		[24] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_21"), -- 요리 방법
		[25] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_22"), -- 연금술 방법
		[26] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_23"), -- 텃밭 설치 및 가꾸기
		[27] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_24"), -- 의뢰 유형 설정 방법
		[28] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_25"), -- NPC 찾는 방법
		[29] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_26"), -- 흑정령의 분노 사용 방법
	}
end
----------------------------------------------------------------------------------------------------------------
