...
function PetControl_ButtonShow( index )
	...
	MoveAni1:SetStartPosition( self._petInfo:GetPosX(), self._petInfo:GetPosY() )
	MoveAni1:SetEndPosition( self._petInfo:GetPosX(), self._petInfo:GetPosY() )
	...
	MoveAni2:SetStartPosition( self._seal:GetPosX(), self._seal:GetPosY() )
	MoveAni2:SetEndPosition( self._seal:GetPosX(), self._seal:GetPosY() )
	self._seal:SetShow( true )
	-- 따라와
	local MoveAni3 = self._follow:addMoveAnimation( 0.0, endTime, UI_ANI_ADV.PAUI_ANIM_ADVANCE_SIN_HALF_PI )
	MoveAni3:SetStartPosition( self._petInfo:GetPosX(), self._follow:GetPosY() )
	MoveAni3:SetEndPosition( self._follow:GetPosX(), self._follow:GetPosY() )
	...
	MoveAni4:SetStartPosition( self._petInfo:GetPosX(), self._follow:GetPosY() )
	MoveAni4:SetEndPosition( self._follow:GetPosX(), self._follow:GetPosY() )
	-- 찾아
	local MoveAni5 = self._find:addMoveAnimation( 0.0, endTime, UI_ANI_ADV.PAUI_ANIM_ADVANCE_SIN_HALF_PI )
	MoveAni5:SetStartPosition( self._petInfo:GetPosX(), self._find:GetPosY() )
	MoveAni5:SetEndPosition( self._find:GetPosX(), self._find:GetPosY() )
	...
	MoveAni6:SetStartPosition( self._petInfo:GetPosX(), self._getItem:GetPosY() )
	MoveAni6:SetEndPosition( self._getItem:GetPosX(), self._getItem:GetPosY() )
...
function Panel_Window_PetControl_ShowToggle()
	...
	if Panel_Party:GetShow() or Panel_LocalWar:GetShow() then
		PartyPanel_Repos()
	end
end
