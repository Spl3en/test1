...
elseif isGameTypeEnglish() then
	movieDesc = {
		[0] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_0"), -- "캐릭터 기본 이동",					-- 0
				...
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_10"), -- "채집과 가공 방법",					-- 13
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_11"), -- "공헌도 : 거점 연결 및 회수",			-- 14
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_12"), -- "공헌도 : 집 용도 변경 및 회수",			-- 15
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_13"), -- "공헌도 : 대여 아이템 활용",			-- 16
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_14"), -- "말 조련 및 마구간 등록",				-- 17
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_15"), -- "일꾼 고용 및 일 시키기",				-- 18
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_16"), -- "낚시하기",							-- 19
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_17"), -- "NPC 지식 모으기",					-- 20
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_18"), -- "NPC 발견 조건",					-- 21
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_19"), -- "이야기 교류 및 친밀도 상점",			-- 22
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_20"), -- "주거지 배치 및 이사 안내",				-- 23
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_21"), -- "요리 방법",						-- 24
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_22"), -- "연금술 방법",						-- 25
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_23"), -- "텃밭 설치 및 가꾸기",					-- 26
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_24"), -- "의뢰 유형 설정 방법",					-- 27
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_25"), -- "NPC 찾는 방법",					-- 28
				PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_26"), -- "흑정령의 분노 사용 방법",				-- 29
	}
else
	movieDesc = {
		[0] =	PAGetString(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_640_MOVIEDESC_0"), -- "캐릭터 기본 이동",   	            -- 0
...
--}
		...
		elseif ( titleNo == 14 ) then
			_movieTheater_640:TriggerEvent( "PlayMovie", "coui://UI_Movie/Movie_Guide/World_Guide_04.webm")
			playedNo = 14
		elseif ( titleNo == 15 ) then	-- 141224 추가
			_movieTheater_640:TriggerEvent( "PlayMovie", "coui://UI_Movie/Movie_Guide/World_Guide_05.webm")
			playedNo = 15
		elseif ( titleNo == 16 ) then
			_movieTheater_640:TriggerEvent( "PlayMovie", "coui://UI_Movie/Movie_Guide/World_Guide_06.webm")
...
function Panel_MovieTheater640_Replay()
	...
	elseif isGameTypeEnglish() then
		...
		elseif ( playedNo == 18 ) then
			_movieTheater_640:TriggerEvent( "PlayMovie", "coui://UI_Movie/Movie_Guide/World_Guide_08.webm")
		elseif ( playedNo == 19 ) then	-- 141224 추가
			_movieTheater_640:TriggerEvent( "PlayMovie", "coui://UI_Movie/Movie_Guide/World_Guide_09_Fish.webm")
		elseif ( playedNo == 20 ) then
			_movieTheater_640:TriggerEvent( "PlayMovie", "coui://UI_Movie/Movie_Guide/World_Guide_10_Wp.webm")
		elseif ( playedNo == 21 ) then
