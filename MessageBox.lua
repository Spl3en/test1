...
function setCurrentMessageData(currentData, position)
	if currentData ~= nil then
		...
		elseif (2 == buttonShowCount) then
			buttonYes:SetPosX( ( Panel_Win_System:GetSizeX() / 2 ) - 95 )
			buttonNo:SetPosX( ( Panel_Win_System:GetSizeX() / 2 ) + 4 )
			
			buttonApply:SetPosX( ( Panel_Win_System:GetSizeX() / 2 ) - 95 )
			buttonIgnore:SetPosX( ( Panel_Win_System:GetSizeX() / 2 ) + 4 )

			buttonCancel:SetPosX( ( Panel_Win_System:GetSizeX() / 2 ) + 4 )
