...
local 	_buttonQuestion = UI.getChildControl( Panel_Window_Inventory, "Button_Question" )								-- 물음표 버튼
	...
	btn_Manufacture:addInputEvent( "Mouse_LUp", "Inventory_ManufactureBTN()") -- 인벤토리 기본노출 가공하기 버튼.
...
function inven:init()	
	...
	btn_AlchemyStone			:addInputEvent( "Mouse_LUp", "FGlobal_AlchemyStone_Open()" )
	btn_AlchemyFigureHead		:addInputEvent( "Mouse_LUp", "FGlobal_AlchemyFigureHead_Open()" )
	btn_DyePalette				:addInputEvent( "Mouse_LUp", "HandleClicked_Inventory_Palette_Open()" )
